...
async function perform_code_completion(params: {
  ...
  if (!code_completions_settings.provider) {
    vscode.window.showErrorMessage(
      'API provider is not specified for Code Completions tool. Go to Gemini Coder panel -> API Tools tab -> Configure API Tools.'
    )
    Logger.warn({
    ...
    vscode.window.showErrorMessage(
      'Model is not specified for Code Completions tool. Go to Gemini Coder panel -> API Tools tab -> Configure API Tools.'
    )
    Logger.warn({
      function_name: 'perform_code_completion',
