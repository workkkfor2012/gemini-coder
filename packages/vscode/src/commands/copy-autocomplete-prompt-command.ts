...
export function copy_autocomplete_prompt_command(file_tree_provider: any) {
    return vscode.commands.registerCommand('geminiCoder.copyAutocompletePrompt', async () => {
        ...
        vscode.window.showInformationMessage('Autocomplete prompt copied to clipboard!');
    });
}