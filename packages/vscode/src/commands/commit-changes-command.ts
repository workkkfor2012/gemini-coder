  ...
  return vscode.commands.registerCommand(
    ...
    async (source_control?: vscode.SourceControl) => {
      ...
      try {
        ...
        // Generate commit message using same logic as generate_commit_message_command
  ...
  return await vscode.window.withProgress(
    {
      ...
      title: `Generating commit message and committing... Sent about ${formatted_token_count} tokens.`,
      cancellable: true
    },
    async (_, token) => {
      const messages = [
...
function build_files_content(files_data: FileData[] | undefined): string {
