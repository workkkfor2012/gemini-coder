...
export const code_completion_instruction_external =
  'Find correct replacement for the <missing text> symbol. Send replacement text in a markdown code block that starts with comment "// Code completion" and explain your reasoning. Always refer to symbol "<missing_text>" as "cursor position" and "replacement" as "completion".'
