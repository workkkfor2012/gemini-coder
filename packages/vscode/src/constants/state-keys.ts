...
export const TOOL_CONFIG_REFACTORING_STATE_KEY =
...
export const DEFAULT_REFACTORING_CONFIGURATION_STATE_KEY =
...
export const LAST_SELECTED_REFACTORING_CONFIG_INDEX_STATE_KEY =
