declare const styles: {
  ...
  readonly "footer__left": string;
  readonly "footer__left__button": string;
  readonly "footer__left__button--active": string;
  readonly "footer__left__button--disabled": string;
  readonly "footer__left__button--fim": string;
