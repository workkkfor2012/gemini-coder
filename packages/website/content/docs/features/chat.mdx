...
Gemini Coder's Chat feature provides a seamless way to interact with various AI platforms directly from VS Code. By connecting your editor with web-based AI services, you can send context and prompts without constant copy-pasting, while taking advantage of the superior developer experience (tabs, public sharing, canvas, not worrying about expenses, etc.).
...
Enter follow-up prompts in the web browser or start over with updated context and prompt (better results).
...
The [browser connector](/docs/installation/browser-connector) establishes a WebSocket connection with VS Code, allowing hands-free chat initialization with your selected context and prompt.
