...
export function copy_refactor_prompt_command(file_tree_provider: any) {
    return vscode.commands.registerCommand('geminiCoder.copyRefactorPrompt', async () => {
        ...
        vscode.window.showInformationMessage('Refactoring prompt copied to clipboard!');
    });
}