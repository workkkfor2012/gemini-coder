<div align="center">
  ...
  <br>
  <h1>Gemini Coder</h1>
  <h4>Copy context for chatbots or initialize them hands-free.<br/>Trigger FIM completion, refactor any file or apply AI suggested changes with the free Gemini API.</h4>
  <br>
